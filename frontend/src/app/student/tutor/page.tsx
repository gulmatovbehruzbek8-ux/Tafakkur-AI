            ...
            {MODES.map((mode) => {
              ...
              return (
                ...
                >
                  ...
                  <p className={`text-[10px] leading-tight line-clamp-2 ${isActive ? 'text-slate-300' : 'text-slate-500'}`}>
                    {mode.desc}
                  </p>
                </button>
              );
          ...
          <div className="bg-white rounded-3xl border border-slate-200/80 shadow-xs flex flex-col h-[600px] overflow-hidden">
            ...
            <div className="px-6 py-3.5 bg-slate-50/80 border-b border-slate-200 flex items-center justify-between text-xs">
              ...
              <span className="font-mono text-[11px] text-slate-500">
                Rejim: <strong className="text-slate-800">{activeMode}</strong> | Qiyinlik: {difficulty}
              </span>
            </div>
                          ...
                          {m.quiz.options.map((opt, optIdx) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                {hasAnswered && isCorrect && <span className="text-emerald-600 font-bold">✓ To'g'ri</span>}
                                {hasAnswered && isSelected && !isCorrect && <span className="text-red-600 font-bold">✗ Xato</span>}
                              </button>
                            );
                          })}
                        </div>
