...
export default function StudentChatbot() {
  ...
  const handleSend = async (userText: string) => {
    ...
    try {
      const prompt = `Talaba savoliga javob berayotgan universitetning intellektual repetitori (Tafakkur AI) sifatida aniq, pedagogik jihatdan foydali va samimiy javob bering. O'zbek tilida yozing.\n\nSavol: ${userText}`;
